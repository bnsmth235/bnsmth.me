          ...
          <ul className="flex flex-row justify-between">
            <li>
              <a href="https://www.github.com/bnsmth235" target="_blank" rel="noopener noreferrer">
                <Button text="GitHub" img={arrow} className="px-8 py-2 text-gray-800 hover:bg-[#69aadf] nunito-sans-medium grow-button" />
              </a>
            </li>
            <li>
              <Link to="contact" smooth={true} duration={1000} spy={true} activeClass="active">
                <Button text="Hire me" className="px-8 py-2 text-gray-800 hover:bg-[#69aadf] nunito-sans-medium grow-button" />
              </Link>
            </li>
          </ul>
        </div>
