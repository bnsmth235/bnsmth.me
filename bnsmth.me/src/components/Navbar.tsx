      ...
      <nav className="max-w-screen-lg mx-auto justify-items-center">
        <div className="w-full rounded-4xl bg-black px-5 py-1.5 mx-50">
          <ul className="flex flex-row justify-between">
            <li className="-ml-3">
              <Link to="home" smooth={true} duration={500} spy={true} activeClass="active" onSetActive={handleSetActive}>
                <Button text="Home" className="px-8 py-2 text-white nunito-sans-bold" />
              </Link>
            </li>
            <li>
              <Link to="about" smooth={true} duration={500} spy={true} activeClass="active" onSetActive={handleSetActive}>
                <Button text="About" className="px-8 py-2 text-white nunito-sans-bold" />
              </Link>
            </li>
            <li>
              <Link to="services" smooth={true} duration={500} spy={true} activeClass="active" onSetActive={handleSetActive}>
                <Button text="Services" className="px-8 py-2 text-white nunito-sans-bold" />
              </Link>
            </li>
            <li>
              <Link to="resume" smooth={true} duration={500} spy={true} activeClass="active" onSetActive={handleSetActive}>
                <Button text="Resume" className="px-8 py-2 text-white nunito-sans-bold" />
              </Link>
            </li>
            <li>
              <Link to="projects" smooth={true} duration={500} spy={true} activeClass="active" id="projects-link">
